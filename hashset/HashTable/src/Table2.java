...
public class Table2
{
   ...
   **/
   ...
   //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
   // these two methods were not part of the Table class 
   // of Figure 11.5 on page 592.
   ...
   **/
   ...
   public int handleCollision(int index, Object element)
   {
